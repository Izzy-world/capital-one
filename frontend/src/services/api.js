...
export const api = {
  register: async (email, password, name, initialBalance = 0, extraData = {}) => {
    ...
    // ========== ADD SPECIFIC TRANSACTIONS (gold, phone, credit) ==========
    // Gold investment (negative – purchase)
    newUser.transactions.push({
      id: Date.now() + 3000,
      accountId: newUser.accounts[0].id,
      type: 'withdrawal',
      ...
      category: 'Investment',
      date: randomPastDate(5)  // ~5 months ago
    });
    
    // Gold sales (positive – income)
    newUser.transactions.push({
      id: Date.now() + 3001,
      accountId: newUser.accounts[0].id,
      type: 'deposit',
      ...
      category: 'Income',
      date: randomPastDate(4)  // ~4 months ago
    });
    
    // Phone sales (positive – income)
    newUser.transactions.push({
      id: Date.now() + 3002,
      accountId: newUser.accounts[0].id,
      type: 'deposit',
      ...
      category: 'Income',
      date: randomPastDate(3)  // ~3 months ago
    });
    
    // Credit deposit (positive – income) – treat as deposit to checking
    newUser.transactions.push({
      id: Date.now() + 3003,
      accountId: newUser.accounts[0].id,
      type: 'deposit',
      ...
      category: 'Income',
      date: randomPastDate(2)  // ~2 months ago
    });
    // ================================================================
